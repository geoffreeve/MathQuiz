...
class Math:
    ...
    def selection():
        ...
        rounds = Math.number_checker("How many rounds: ", 1, 100000, "Please enter a valid integer higher than 0")
...
# Calling selection function inside of Math class to ask user for their math quiz preferences.
Math.selection()